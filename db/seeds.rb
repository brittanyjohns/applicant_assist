...
# Product.delete_all
Product.find_or_create_by name: "10 coins", price: 1, coin_value: 10, active: true, product_category: coins
Product.find_or_create_by name: "100 coins", price: 10, coin_value: 100, active: true, product_category: coins
Product.find_or_create_by name: "200 coins", price: 15, coin_value: 200, active: true, product_category: coins
Product.find_or_create_by name: "500 coins", price: 20, coin_value: 500, active: true, product_category: coins
...
Prompt.create! subject: "Resume Rewrite", body: "Please rewrite the following resume, highlighting things that align with what this job posting is looking for.", active: false
Prompt.create! subject: "Sample Interview Questions", body: "Give me 3 interview questions that you think would be asked for this job and use my resume to answer those questions for me, as me.", active: false
