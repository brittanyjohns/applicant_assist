...
class PromptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prompt" do
    assert_difference("Prompt.count") do
      post prompts_url, params: { prompt: { active: @prompt.active, body: @prompt.body, subject: @prompt.subject } }
    end
  ...
  test "should update prompt" do
    patch prompt_url(@prompt), params: { prompt: { active: @prompt.active, body: @prompt.body, subject: @prompt.subject } }
